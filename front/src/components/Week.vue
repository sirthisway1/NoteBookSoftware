            ...
            <div class="content-wrapper">
                ...
                <div class="timeMessage" >
                    ...
                    <p v-if="timeActivity.updatedAt && timeActivity.title">
                        在 {{ timeActivity.updatedAt }}，你还在写 {{ timeActivity.title }} ，看来你很关心{{ keywords }}
                    </p>
                    <p v-else>暂无时间信息</p>
...
export default {
    ...
    methods: {
        ...
        //     // if (!this.timeActivity || !this.timeActivity.content) {
        //     //     console.error('No note selected or note content is empty');
        //     //     return;
        //     // }
        //     console.log('内容：',this.timeActivity.content);
        //     const token = localStorage.getItem('token');
        //     if (!token) {
        //         alert('请先登录');
        //         return;
        ...
        //         {
        //             text: this.timeActivity.content
        //         },
        //         { 
        //             headers: { 
        ...
        //         // this.keywordSummaries = keywords.join(', '); // 将关键词数组转换为字符串
        //         } else {
